  ...
  return (
    <div className="relative flex flex-col items-center justify-center w-full bg-[#F8F5F0] py-20 px-6 overflow-hidden">
      ...
      <img
        src={handLeft}
        alt="Hand left"
        className="hidden md:block absolute top-[-44px] left-0  w-32 lg:w-40 z-10"
      />
      <img
        src={handRight}
        alt="Hand right"
        className="hidden md:block absolute right-0 bottom-[-80px]  w-32 lg:w-40 z-10"
      />
      ...
      <div className="w-[550px] text-center flex flex-col gap-6 relative z-30">
        ...
        {/* Subheading */}
        <p className="text-base sm:text-lg font-semibold text-[#1F392C]">
